        ...
        <nav class="navbar navbar-expand-xl d-flex align-items-center p-0">
          ...
          >
            <ul class="navbar-nav m-auto">
              ...
              <li class="nav-item">
                <a class="nav-link " href="/new/#qualification">
                 Experience
                </a>
              </li>

              <li class="nav-item">
                <a class="nav-link " href="/new/#projects">
                  Projects
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="/new/#industry" aria-disabled="true">
                  Industry Area
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link " href="/new/#pricing">
                  Process
                </a>
              </li>
              {/* <li class="nav-item">
