      ...
      <div className="container">
        <div className="row">
          <div className="contact-header col-lg-7">
            ...
            <p>
              Share your product idea, technical requirement, or project scope. I’ll review it and respond with the right next step.
            </p>
          </div>
        </div>
        ...
        <div className="contact-content">
          <div className="contact-info-card h-100">
            ...
            <p className="contact-info-description">
              SaaS platforms, APIs, automation systems, mobile apps, product websites, and DevOps support.
            </p>
            ...
            <div className="contact-info-box">
              ...
              <div className="contact-info-value">
                Full Stack Developer • SaaS Engineer • DevOps
              </div>
            </div>
            ...
            <div className="contact-info-box">
              ...
              <div className="contact-info-value">
                Open for freelance, contract, and long-term product work
              </div>
            </div>
          </div>
              ...
              <div className="contact-form-row">
                <div className="contact-form-group contact-form-group-full">
                  <input
                    type="text"
                    className="contact-input"
                    placeholder="Estimated Budget or Monthly Scope"
                  />
                </div>
              </div>
