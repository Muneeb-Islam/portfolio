...
const ContactSection = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    if (!name || name[0] !== name[0].toUpperCase()) {
      enqueueSnackbar("First letter of the Name must be capitalized.", {
        variant: "error",
      });
      return;
    }
  ...
  if (isLoading) {
    return (
      ...
      >
        <CircularProgress
          sx={{ color: "var(--wb-website-theme-secondary-color)" }}
        />
      </div>
    );
  }
        ...
        <div className="row justify-content-center">
          <div className="col-lg-8 text-center">
            <div className="form-main-wrapper">
              <h2>
                Have Question?{" "}
                <span className="font-style">Write a Message</span>
              </h2>
                  ...
                  <div className="col-12 mt-4">
                    ...
                    <div className="upload-files mt-3">
                      ...
                      <label htmlFor="upload-file">
                        <a className="form-btn">Choose File</a>
                      </label>
                      <Typography
                        variant="body2"
                        className="ms-1"
