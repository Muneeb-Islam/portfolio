...
<section className="top_services_wrapper">
    <div className="container">
                    ...
                    <div id="testimonial-carousel" className="carousel slide" data-bs-ride="carousel">
                        <div className="carousel-inner">
                            <div className="carousel-item active" data-bs-interval="4000">
                                <p>“The user-friendly templates from the Vision have helped me a lot in creating my dream website”</p>
                   
                                <div className="d-flex justify-content-center justify-content-lg-start align-items-center pt-4">
                            ...
                            <div className="carousel-item" data-bs-interval="4000">
                                <p>“I love how I get the calendar management within my coaching website. It has made it easy for me to organize my events.”</p>
                            ...
                            <div className="carousel-item" data-bs-interval="2000">
                                <p>“Being someone with no knowledge of coding or website creation, the templates from Vision helped me a great deal in creating my dream webpage."</p>
        ...
        <div className="row justify-content-center justify-content-lg-between text-center tech-main">
            <div className="col-md-4 col-lg-2 hover-effect">
            ...
            <div className="col-md-4 col-lg-2 pt-5 p-md-0 hover-effect">
            <span className="elementor-icon"> <img src="/assets/crm.png" alt="" className="img-fluid" /></span>
                <h3>Program Drip System</h3>
                <p>No need for a third party to send and receive mail when you can get a program drip system that simplifies campaign management.</p>
            </div>
            ...
            <span className="elementor-icon"><img src="/assets/customer-support.png" alt="" className="img-fluid" /></span>
            ...
            <span className="elementor-icon"><img src="/assets/hand.png" alt="" className="img-fluid" /></span>
                ...
                <p>We understand the need for a secure website and therefore provide a safe and secure place for you and your users. </p>
            </div>
        </div>
        </div>
</section>
