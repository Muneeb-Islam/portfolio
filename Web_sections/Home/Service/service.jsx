        ...
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-lg-8 text-center wow fadeInUp">
              ...
              <p>
                At Vision, we take pride in offering a diverse range of IT
                services designed to meet your unique needs. Whether you are a
                small business or a large enterprise, we have the expertise and
                solutions to make your digital presence stand out and improve
                your operations.
              </p>
            </div>
          </div>
            ...
            <Slider {...settings}>
              <div className=" px-2 position-relative img-div">
                ...
                <div className="overlay">
                  <img
                    src="/assets/coaching (1).png"
                    alt=""
                    className="img-fluid mb-3"
                  />
                  <h3>Life Coaching</h3>
                  <p>
                    Whether you're seeking guidance in a specific area of your
                    life or looking for a holistic transformation, we're here to
              ...
              <div className=" px-2 position-relative img-div">
                ...
                <div className="overlay">
                  ...
                  <h3>Business Consulting</h3>
                  <p>
                    Explore how our consulting services can drive meaningful
                    change and propel your business to new heights.
                  </p>
                </div>
              </div>
              <div className=" px-2 position-relative img-div">
                <img
                  src="/assets/hair-beauty.png"
                  className="img-fluid w-100"
                  alt="..."
                />
                <div className="pos-content">
                ...
                <div className="overlay">
                  ...
                  <h3>Hair And Beauty</h3>
                  <p>
                    Book an appointment or organize your workflow. Let your
                    business flourish with Vision.{" "}
                  </p>
                </div>
              </div>
              <div className=" px-2 position-relative img-div">
                ...
                <div className="overlay">
                  <img
                    src="/assets/weights (1).png"
                    alt=""
                    className="img-fluid mb-3"
                  />
                  <h3>Fitness</h3>
                  <p>
                    Get yourself an easy-to-use and user-friendly template that
                    fits perfectly to your need for a fitness page.{" "}
                  </p>
                </div>
              </div>
              <div className=" px-2 position-relative img-div">
                ...
                <div className="overlay">
                  ...
                  <h3>Health</h3>
                  <p>
                    Whether choose the old template or create your own, we
                    support health webpages and therefore deliver perfection.{" "}
                  </p>
                </div>
              </div>
              <div className=" px-2 position-relative img-div">
                ...
                <div className="overlay">
                  ...
                  <h3>Education</h3>
                  <p>
                    By understanding the needs of an educational webpage, we
                    have web pages that only need for you to drag and drop your
                    data.{" "}
                  </p>
                </div>
              </div>
