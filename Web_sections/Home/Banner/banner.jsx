  ...
  <div className="container">
    <div className="row align-items-center">
      <div className="col-lg-6 order-2 order-lg-1 mt-5 mt-lg-0 wow slideInLeft">
        ...
        <p>At Vissioon, we are your all-in-one solution for membership management, business consulting, sales generation, and business growth. Our services aim to maximize your business's potential. Stay informed through our news feed and manage it all with our CRM/CMS platform.</p>
