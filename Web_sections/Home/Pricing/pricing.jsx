        ...
        <div className="container" >
            ...
            <div className="row justify-content-center pt-4">
                <div className="col-md-6 col-lg-4 pt-4">
                    ...
                    <span className="elementor-icon">    <img src="/assets/pricing-plan-icon1.png" alt="" className="img-fluid" /></span>
                     
                        <h3>Beginner</h3>
                        <div
                            className="d-flex justify-content-center justify-content-md-start align-items-baseline plan-per-text wp-pt-20">
                            <h2>$5000</h2>
                            <h4>/Month</h4>
                        </div>
                ...
                <div className="col-md-6 col-lg-4 pt-4">
                    <div className=" redlight-pricing-card h-100">
                    <span className="elementor-icon">  <img src="/assets/price-2.png" alt="" className="img-fluid" /></span>
                ...
                <div className="col-md-6 col-lg-4 pt-4">
                    <div className=" redlight-pricing-card h-100">
                    <span className="elementor-icon">  <img src="/assets/price-3.png" alt="" className="img-fluid" /></span>
