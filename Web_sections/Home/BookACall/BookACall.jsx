...
function BookACall() {
  ...
  return (
    <>
      <section className="book-a-call-wrapper  mt-80" id="bookACall">
        <div className="container">
          ...
          {changeNextForm ? (
            <>
              <div className="row justify-content-center just-shadow p-3 p-lg-5">
                <div className="col-12 col-lg-5 form-slots">
                ...
                <div className="col-12 col-lg-7 mb-4 mb-lg-0 ps-0 px-0 px-lg-4">
                  <form
                    autoComplete="off"
                    onSubmit={(e) => {
                      e.preventDefault();
            ...
            <>
              <div className="row justify-content-center just-shadow">
                ...
                <div className="col-12 col-lg-5 mb-4 mb-lg-0">
                  {selectedDate && (
                    <div className="book-a-call-slots">
                      <h3>Time Slots:</h3>
                      <p className="mb-1">
                        {moment(selectedDate).format("LL")}
                      </p>
                      {selectedSlot && (
                        <div className="d-flex align-items-center justify-content-between mb-2">
                          ...
                          <button
                            className="book-a-call-contained-button"
