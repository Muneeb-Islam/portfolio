      ...
      <div className="relative mx-auto grid max-w-7xl items-center gap-12 px-4 pb-28 pt-0 sm:px-6 lg:grid-cols-2 lg:px-8">
        <div>
          <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-2 text-sm text-white/80 backdrop-blur">
            ...
            Available for new SaaS, Web & Mobile App Projects
          </div>

          <h2 className="max-w-2xl text-4xl font-black leading-tight sm:text-5xl lg:text-5xl">
          ...
          <p className="mt-4 max-w-xl text-base leading-7 text-white/70">
            I help startups and businesses build scalable, production-ready applications using modern technologies, clean architecture, and user-focused design.
          </p>
