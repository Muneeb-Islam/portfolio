...
const _get_website_setting_from_localStorage = () => {
  if (typeof window !== "undefined") {
    return JSON.parse(localStorage.getItem("website_setting"));
  } else return {};
};

const _set_website_setting_in_localStorage = (data) => {
...
module.exports = {
  ...
  _get_website_setting_from_localStorage,
  _set_website_setting_in_localStorage,
};
